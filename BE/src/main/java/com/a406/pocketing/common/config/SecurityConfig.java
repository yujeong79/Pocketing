...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/ws/**", "/api/files/presigned-url", "/api/groups/all", "/api/members/all", "/api/photocards/**", "/api/posts/cheapest/**", "/actuator/health").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "https://pocketing.app"));
